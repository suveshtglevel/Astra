...
export default function Terms() {
  return (
    <div className="min-h-screen py-24 px-6 md:px-12 max-w-4xl mx-auto">
      <h1 className="text-4xl md:text-5xl font-serif text-gradient mb-8">Terms & Conditions</h1>
      ...
      <div className="bg-white/5 border border-white/10 p-8 rounded-2xl text-brand-gray space-y-6">
        ...
        <div>
          <h2 className="text-xl text-brand-light font-medium mb-2">1. Acceptance of Terms</h2>
        ...
        <div>
          <h2 className="text-xl text-brand-light font-medium mb-2">2. Subscriptions</h2>
        ...
        <div>
          <h2 className="text-xl text-brand-light font-medium mb-2">3. User Conduct</h2>
