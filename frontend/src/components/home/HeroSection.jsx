...
export default function HeroSection() {
  ...
  const yChart = useTransform(scrollY, [0, 1000], [0, 150]);
  return (
    <section className="relative min-h-screen flex items-center z-10 overflow-hidden px-8">
      ...
      <div className="max-w-7xl mx-auto w-full pt-28 pb-20 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center relative z-10">
        <div>
          ...
          <h1 className="mb-6 font-serif leading-[1.1]">
            <span className="block text-[clamp(40px,6.5vw,72px)] text-white/90">
               <AnimatedText text="Hello," delayOffset={0.2} />
            </span>
            <span className="block text-[clamp(40px,6.5vw,72px)]" style={{ background: 'linear-gradient(110deg, rgb(181, 150, 255) 0%, rgb(139, 124, 248) 40%, rgb(231, 195, 106) 90%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
               <AnimatedText text="Celestial Soul." delayOffset={0.8} />
            </span>
          </h1>
          ...
          <p className="text-[16px] text-white/38 leading-[1.7] max-w-md mb-12" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 400 }}>Your birth chart is a map of the sky at the exact moment you arrived. Klue decodes it — daily, in real time.</p>
        ...
        <motion.div style={{ y: yChart }} className="relative hidden lg:flex items-center justify-center">
